...
if (isset($_SESSION['patientSessionActive'])) {
    ...
    $reportsTable = ' <table class="table table-bordered table-nowrap mb-0 table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td>Weight</td>
                                <td><input type="text" class="form-control" name="mq1" value=""></td>
                                <td><input type="text" class="form-control" name="fq1" value=""></td>
    ...
    if (mysqli_num_rows($activePatientReports) > 0) {
        ...
        $reportsTable = ' <table class="table table-bordered table-nowrap mb-0 table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td>Weight</td>
                                    <td><input type="text" class="form-control" name="mq1" value="' . $maleJson['mq1'] . '"></td>
                                    <td><input type="text" class="form-control" name="fq1" value="' . $femaleJson['fq1'] . '"></td>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="d-flex align-items-center">
                                    <h5 class="card-title mb-0">Patient Diagnosis Reports</h5>
                                </div>
                            </div>
                        </div>
                    </div>
