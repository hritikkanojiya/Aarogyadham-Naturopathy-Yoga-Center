...
if (isset($_SESSION['therapistSessionActive'])) {
    ...
    $activeTherapistData = mysqli_query($naturopathyCon, "SELECT * FROM `therapistregistration` WHERE id = '$therapistUserId'");
    ...
    if (isset($_POST['resetPass'])) {
        ...
        if ($cpass == $activeTherapistDataResult['password']) {
            $updatePass = mysqli_query($naturopathyCon, "UPDATE `therapistregistration` SET `password` = '$npass' WHERE `therapistregistration`.`id` = $therapistUserId");
